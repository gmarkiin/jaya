...
class PaymentCancelRequestTest extends TestCase
{
    ...
    public function testPaymentCancelSuccessful()
    {
        DB::table('payments')
            ->insert([
        ...
        $response = $this->json('DELETE', '/api/rest/payments/290c4906-c031-433e-bb44-48d4a1f611e6');
    ...
    public function testPaymentCancelFailed()
    {
        $response = $this->json('DELETE', '/api/rest/payments/290c4906-c031-433e-bb44-48d4a1f611e3');
